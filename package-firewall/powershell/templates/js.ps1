...
#
# Auth note: .npmrc uses _auth (base64-encoded key:secret).
#   _authToken causes 401 with bun. _auth is verified working for all tools above.
#
# Yarn classic reads .npmrc for auth (same behaviour as macOS).
...
Write-Host '[endor-js]   covers: npm, pnpm, yarn classic, bun'
